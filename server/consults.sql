...
WHERE ti.Nombre = [recuperado de vistas]
...
FROM Contrato JOIN Inmueble on Contrato.Inmueble = Inmueble.id
    ...
    JOIN Cliente on Contrato.Comprador = Cliente.Cedula
WHERE Tipo_Contrato.Nombre = 'Compra' and [Fecha_Inicio de vista] < Contrato.Fecha_Venta and [Fecha_Fin de vista] > Contrato.Fecha_Venta